...
class AdvancedMarketScanner:
    def __init__(self):
        ...
        # Enhanced scanning universe
        self.scan_symbols = [
            'BTC/USDT', 'ETH/USDT', 'SOL/USDT', 'ADA/USDT', 'DOT/USDT',
            'AVAX/USDT', 'LINK/USDT', 'ATOM/USDT', 'NEAR/USDT', 'MATIC/USDT',
            'UNI/USDT', 'AAVE/USDT', 'LTC/USDT', 'XRP/USDT', 'BNB/USDT'
        ]
    ...
    def comprehensive_market_scan(self):
        ...
        logger.info(f"Running comprehensive market scan on {len(self.scan_symbols)} symbols...")
